          ...
          <div className="flex flex-col space-y-12">
            ...
            <div>
              ...
              <p className="text-[#D8D3CC] leading-relaxed text-base" style={{ lineHeight: "1.75" }}>
                Discover the essence of Armenia through our carefully curated signature journeys. 
                Each tour is designed to showcase the rich cultural heritage, stunning landscapes, 
                and authentic wine traditions that make Armenia a unique destination. From ancient 
                monasteries to modern wineries, experience the perfect blend of history, culture, 
                and gastronomy.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[#D8D3CC] leading-relaxed text-base" style={{ lineHeight: "1.75" }}>
                All our signature journeys include professional English-speaking guides, comfortable 
                transportation, entrance fees to all attractions, traditional Armenian meals, 
                bottled water, and convenient hotel pickup and drop-off services. We ensure every 
                detail is taken care of so you can fully immerse yourself in the experience.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[#D8D3CC] leading-relaxed text-base" style={{ lineHeight: "1.75" }}>
                "An absolutely incredible experience! The guides were knowledgeable, the wine 
                tastings were exceptional, and the cultural sites were breathtaking. This tour 
                exceeded all our expectations and gave us a deep appreciation for Armenian 
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="bg-[#1A0F0A] rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-5">
                ...
                {/* Date Selection */}
                <div>
                  <label className="block text-sm text-[#D8D3CC] mb-2 font-medium">Date</label>
                  <input
                    type="date"
                    value={selectedDate}
