...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1A0F0F] text-white" suppressHydrationWarning>
      {/* Main Footer Content */}
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  ...
                  className="flex items-start gap-3 text-sm text-gray-300 transition-colors hover:text-[#D1B06B]"
                >
                  <svg
                    className="mt-0.5 h-5 w-5 flex-shrink-0 text-[#D1B06B]"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden
              ...
              <li>
                <Link
                  href={withLocale("/terms-conditions")}
                  className="flex items-start gap-3 text-sm text-gray-300 transition-colors hover:text-[#D1B06B]"
                >
                  <svg
                    className="mt-0.5 h-5 w-5 flex-shrink-0 text-[#D1B06B]"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a
                  href="mailto:contact@wineroad.am"
                  className="text-gray-300 hover:text-[#D1B06B] transition-colors text-sm"
                >
                  contact@wineroad.am
                </a>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    href="viber://chat?number=37444499441"
                    className="w-10 h-10 rounded-lg bg-[#2B1D1A] hover:bg-[#3a2a27] flex items-center justify-center transition-colors group"
                    aria-label="Viber"
                  >
                    <svg
                ...
                components={{
                  vcode: (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#D1B06B] underline-offset-2 hover:text-[#e4c78a] hover:underline"
                    />
                  ),
                }}
              />
