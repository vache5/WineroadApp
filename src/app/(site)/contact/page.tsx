...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1E1411]">
      ...
      {/* Main Content — centered cards only */}
      <div className="mx-auto max-w-xl px-4 pb-16 md:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <a
                    href="https://mail.google.com/mail/?view=cm&fs=1&to=contact%40wineroad.am"
                    target="_blank"
                  ...
                  <p className="text-sm text-gray-500 mt-1">{t("contact.info.emailAnytime")}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">{t("contact.info.visitOffice")}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span>{t("contact.quick.telegram")}</span>
              </a>
            </div>
          </div>
        </div>
